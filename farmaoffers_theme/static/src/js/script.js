odoo.define('farmaoffers_theme.script', function (require) {
    "use strict";
    ...
    publicWidget.registry.portalDetails = publicWidget.registry.portalDetails.extend({
        ...
        newPatientProgram: function(ev) {
            ...
            count++;
            ajax.loadXML('/farmaoffers_theme/static/src/xml/portal.xml', qweb).then(() => new Promise((resolve, reject) => {
                var $HTML = qweb.render('farmaoffers_theme.PatientProgramFields', {newId: count});
